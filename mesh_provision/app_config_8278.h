...
#define DEV_NAME                "Mesh_GW_Doogle"
...
/////////////////// mesh project config /////////////////////////////////
#define TRANSITION_TIME_DEFAULT_VAL (0x41)  // 0x41: 1 second // 0x00: means no default transition time
...
#define PWMID_R     (GET_PWMID(PWM_R, PWM_FUNC_R)) //1
#define PWMID_G     (GET_PWMID(PWM_G, PWM_FUNC_G)) //0
#define PWMID_B     (GET_PWMID(PWM_B, PWM_FUNC_B)) //3
#define PWMID_W     (GET_PWMID(PWM_W, PWM_FUNC_W)) //4
                    
#define PWM_INV_R   (GET_PWM_INVERT_VAL(PWM_R, PWM_FUNC_R))  //1
#define PWM_INV_G   (GET_PWM_INVERT_VAL(PWM_G, PWM_FUNC_G))  //1
#define PWM_INV_B   (GET_PWM_INVERT_VAL(PWM_B, PWM_FUNC_B))  //1
#define PWM_INV_W   (GET_PWM_INVERT_VAL(PWM_W, PWM_FUNC_W))  //1
